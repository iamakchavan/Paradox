...
import { ResearchStepLoader } from '@/components/chat/research-timeline/ResearchStepLoader';
  ...
  return (
    ...
    >
      <div className="flex h-9 w-9 shrink-0 items-center justify-center text-foreground/65">
        {isStreaming ? <ResearchStepLoader stepType="synthesis" /> : <FileText className="h-[18px] w-[18px]" />}
      </div>
