      ...
      {DISPLAY_BRANDS.map(brand => {
        ...
        return (
          <button
            ...
            className={cn(
              'p-1 rounded-md border transition-[background-color,border-color,box-shadow,filter,opacity,transform] duration-[var(--motion-duration-content)] ease-[var(--motion-ease-out)] shrink-0 hover:scale-105 flex items-center justify-center outline-none focus:outline-none motion-reduce:transform-none',
              isBrandSelected
