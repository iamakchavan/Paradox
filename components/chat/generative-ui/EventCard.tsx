...
export default function EventCard({
  ...
  return (
    <div className="w-full max-w-[320px] sm:max-w-[350px] bg-zinc-50/20 dark:bg-card/65 border border-zinc-200/50 dark:border-white/[0.07] rounded-2xl shadow-3xs overflow-hidden select-none text-foreground animate-in fade-in-50 duration-200">
      ...
      <div className="p-3.5 flex items-center justify-between gap-3 bg-white dark:bg-card">
      ...
      <div className="px-3.5 py-2.5 flex justify-between items-center gap-4 bg-zinc-50/40 dark:bg-secondary/35 border-t border-zinc-100 dark:border-white/[0.06]">
        <div className="flex flex-col min-w-0 flex-1">
