                ...
                <div style={{ padding: isMobile ? '10px 16px 16px' : '10px 24px 24px', position: 'relative' }}>
                  ...
                  >
                    ...
                    <DialogPrimitive.Description style={{ fontSize: isMobile ? 12.5 : 14, color: 'hsl(var(--muted-foreground))', lineHeight: 1.45 }}>
                      Are you sure you want to delete the conversation <span style={{ fontWeight: 600, color: 'hsl(var(--foreground))' }}>&quot;{entryTitle}&quot;</span>?
                    </DialogPrimitive.Description>
                  </motion.div>

                  {/* Red Alert Warning Card */}
                  <motion.div
                  ...
                  >
                    ...
                    <div style={{ fontSize: isMobile ? 12 : 13, color: 'rgb(239, 68, 68)', lineHeight: 1.45, fontWeight: 500 }}>
                      This action is permanent. This will permanently delete this conversation and all associated messages.
                    </div>
                  </motion.div>
