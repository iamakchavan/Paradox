        ...
        <TooltipTrigger asChild>
          ...
          >
            <div className="relative w-4 h-4">
              <svg viewBox="0 0 24 24" fill="none" className={cn('absolute inset-0 w-4 h-4 transition-[opacity,transform] duration-[var(--motion-duration-content)] ease-[var(--motion-ease-out)]', copiedBlockId === blockId ? 'opacity-0 scale-75' : 'opacity-100 scale-100')}>
