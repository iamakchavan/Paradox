        ...
        >
          {isSettingsActive ? (
            <Button
              variant="ghost"
              size="icon"
              className="hidden md:inline-flex h-9 w-9 md:h-10 md:w-10 rounded-full hover:bg-zinc-200/50 dark:hover:bg-white/5 hover:scale-105 active:scale-[0.93] active:duration-75 transition-[transform,background-color,border-color,box-shadow] duration-200 ease-out motion-reduce:transform-none items-center justify-center text-foreground/80 hover:text-foreground"
          ...
          {isSettingsActive && (
            <Button
              variant="ghost"
              size="icon"
              className="inline-flex md:hidden h-9 w-9 rounded-full hover:bg-zinc-200/50 dark:hover:bg-white/5 hover:scale-105 active:scale-[0.93] active:duration-75 transition-[transform,background-color,border-color,box-shadow] duration-200 ease-out motion-reduce:transform-none items-center justify-center text-foreground/80 hover:text-foreground"
              onClick={() => setIsSettingsActive(false)}
              title="Back to chat"
            >
              <ChevronLeft className="h-4 w-4" />
          ...
          <Sheet open={isMobileSidebarOpen} onOpenChange={setIsMobileSidebarOpen}>
            {!isSettingsActive && (
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className="inline-flex md:hidden h-9 w-9 rounded-full hover:bg-zinc-200/50 dark:hover:bg-white/5 hover:scale-105 active:scale-[0.93] active:duration-75 transition-[transform,background-color,border-color,box-shadow] duration-200 ease-out motion-reduce:transform-none items-center justify-center text-foreground/80 hover:text-foreground">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" style={{ color: 'currentColor' }}>
                    <rect y="4.5" width="16" height="2" rx="1" fill="currentColor" />
                    <rect y="9.5" width="11" height="2" rx="1" fill="currentColor" />
                  </svg>
            ...
            {shouldShowNewChatButton && (
              ...
              >
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="h-9 w-9 md:h-10 md:w-10 rounded-full hover:bg-zinc-200/50 dark:hover:bg-white/5 hover:scale-105 active:scale-[0.93] active:duration-75 transition-[transform,background-color,border-color,box-shadow] duration-200 ease-out motion-reduce:transform-none text-foreground/80 hover:text-foreground flex items-center justify-center"
                  title="New chat"
                >
